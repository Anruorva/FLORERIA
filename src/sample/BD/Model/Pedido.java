...
public class Pedido {
    String id, ruta_envio, id_transportista, id_empleado, id_cliente;    Date fch_envio,fch_entrega;

    public Pedido(String id, String ruta_envio, String id_transportista, String id_empleado, String id_cliente, Date fch_envio, Date fch_entrega) {
        this.id = id;
